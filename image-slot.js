...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    async _ingest(file) {
      ...
      try {
        // Encode at the full cap, not 2× the element's CURRENT width: a
        // collapsed accordion panel is ~90px wide when the drop happens but
        // expands past 600px, and a 180px encode would look blurry there.
        const url = await toDataUrl(file, MAX_DIM);
